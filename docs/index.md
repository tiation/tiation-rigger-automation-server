---
layout: default
title: Tiation Rigger Automation Server - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Tiation Rigger Automation Server</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/tiation-rigger-automation-server" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
```bash
# Build Docker image
docker build -t tiation-rigger-automation-server .

# Run container
docker run -p 8080:8080 tiation-rigger-automation-server
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/tiation-rigger-automation-server)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/tiation-rigger-automation-server/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/tiation-rigger-automation-server/discussions)
